...
disease_predictor_model=pickle.load(open('C:\Users\RAHUL KUMAR DUTTA\OneDrive\Desktop\Documents\Disease Prediction using symptoms Web App\disease_predictor.sav','rb'))
